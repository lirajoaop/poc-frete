...
export default function Cart({ items, onUpdate, onRemove, onClearCart }) {
  ...
  if (order) {
    return <OrderSuccess order={order} onReset={handleReset} />;
  }
            ...
            {selectedQuote && (
              <>
                ...
                <button
                  ...
                  className="w-full mt-4 px-4 py-2.5 bg-emerald-700 text-white text-sm font-medium rounded hover:bg-emerald-800 transition"
                >
                  Finalizar pedido
                </button>
              </>
